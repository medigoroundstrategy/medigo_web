...
function Landing({ setView }) {
  const problemFindings = [
    [
      ...
      <>대부분이 그냥 대행사였습니다.<br className="br-mo" />실제로 연락해보면<br className="br-mo" />병원·법률·부동산 마케팅을 함께<br className="br-mo" />진행하고 있었습니다.</>,
    ],
    ["02", "의학을 모르니, 글도 형편없었습니다.", <>진짜 '마케팅'이라 부를 만한 콘텐츠가<br className="br-mo" />거의 없었습니다.</>],
    ["03", "형편없는 글조차 하청을 맡기고 있었습니다.", <>대부분 일반인 블로거에게<br className="br-mo" />의학 원고를 떠넘깁니다.<br />키워드만 전달받아 원고를 씁니다.</>],
  ];
  return (
    <>
